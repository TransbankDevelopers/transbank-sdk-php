...
// Utilities
require_once(__DIR__ . '/src/Onepay/utils/HttpClient.php');
...
require_once(__DIR__ . '/src/Webpay/IntegrationConfiguration.php');
require_once(__DIR__ . '/src/Webpay/Webpay.php');

require_once(__DIR__ . '/src/Webpay/Soap/SoapValidation.php');
require_once(__DIR__ . '/src/Webpay/Soap/WSSecuritySoapClient.php');
require_once(__DIR__ . '/src/Webpay/Soap/WSSESoap.php');
require_once(__DIR__ . '/src/Webpay/Soap/XMLSecEnc.php');
require_once(__DIR__ . '/src/Webpay/Soap/XMLSecurityDSig.php');
require_once(__DIR__ . '/src/Webpay/Soap/XMLSecurityKey.php');

require_once(__DIR__ . '/src/Webpay/Transactions/Concerns/AcknowledgesTransactions.php');
require_once(__DIR__ . '/src/Webpay/Transactions/Concerns/InitializesTransactions.php');
require_once(__DIR__ . '/src/Webpay/Transactions/Concerns/PerformsGetTransactionResults.php');
require_once(__DIR__ . '/src/Webpay/Transactions/Transaction.php');
require_once(__DIR__ . '/src/Webpay/Transactions/WebpayCapture.php');
require_once(__DIR__ . '/src/Webpay/Transactions/WebpayComplete.php');
require_once(__DIR__ . '/src/Webpay/Transactions/WebpayMallNormal.php');
require_once(__DIR__ . '/src/Webpay/Transactions/WebpayNormal.php');
require_once(__DIR__ . '/src/Webpay/Transactions/WebpayNullify.php');
require_once(__DIR__ . '/src/Webpay/Transactions/WebpayOneclick.php');

// Helpers for all Transbank SDK files
require_once(__DIR__ . '/src/Helpers/Fluent.php');
