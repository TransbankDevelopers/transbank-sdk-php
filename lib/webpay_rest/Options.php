...
class Options
{
    ...
    const DEFAULT_WEBPAY_PLUS_MALL_CHILD_COMMERCE_CODE_1 = '597055555536';
    const DEFAULT_WEBPAY_PLUS_MALL_CHILD_COMMERCE_CODE_2 = '597055555537';
    ...
    public $apiKey = null;
    /**
     * @var string $commerceCode Your patpass_comercio code, given by Transbank. Sent as
